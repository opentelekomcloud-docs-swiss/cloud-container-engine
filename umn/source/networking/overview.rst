...
-  The workload accesses the external network.
   ...
   -  Accessing a public network: You need to assign an EIP to the node where the workload runs, or configure SNAT rules through the NAT gateway. For details, see :ref:`Accessing Public Networks from a Container <cce_10_0400>`.
