...
#. Choose **Policies** in the navigation pane, click the **Network Policies** tab, and click **Create Network Policy** in the upper right corner.
   ...
   -  **Outbound Rule**: Click |image2| to add an outbound rule. For details about parameter settings, see :ref:`Table 1 <cce_10_0059__table166419994515>`.
...
.. |image2| image:: /_static/images/en-us_image_0000001897906225.png
